...
create table members (id int primary key auto_increment,gender varchar(1) default '1',nickname varchar(50),firstname varchar(20),middlename varchar(20),lastname varchar(50),region varchar(4),address varchar(200),birthdate date,birthcity varchar(50),nik varchar(20),juleha_id varchar(20),position varchar(200),password varchar(50),mstatus varchar(1) default '1',createdate timestamp default current_timestamp());
